  ...
  useEffect(() => {
    if (selectedDelivery) {
      if (recipientType === 'motorista') {
        setCustomText(
          `Olá ${selectedDelivery.motorista}! Aqui é o Agente Rodovar monitorando sua carga para ${selectedDelivery.destino}. Conforme nossa programação de rastreio, por favor nos envie sua localização em tempo real. Granto e boa viagem!`
        );
      } else {
        setCustomText(
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        ...
        {/* Right Side: List of upcoming / history schedules */}
        <div className="lg:col-span-7 bg-[#121212] border border-zinc-800 p-5 rounded-xl flex flex-col justify-between space-y-4">
          <div className="flex items-center justify-between border-b border-zinc-900 pb-3">
            <div className="flex items-center gap-2">
              ...
              <h3 className="font-bold text-sm uppercase tracking-wider font-sans">Agenda de Envio Rodovar</h3>
            </div>
